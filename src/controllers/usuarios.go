...
//pacote responsável por receber requisições e fazer devidas ações antes de interagir com  o banco de dados
import (
...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	//aqui eu criei um repositorio(struct usuarios que tem um db e metodos) cujo db é o devbook
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	//aqui eu chamei a função criar pra de fato inserir no db
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	defer db.Close()
	//usando metodos do repositorio para interagir com banco para obter senha salva (detalhes na func criarusuario)
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	...
	//usando metodos do repositorio para interagir com banco para inserir senha nova (detalhes na func criarusuario)
