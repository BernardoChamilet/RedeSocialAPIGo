...
//token serve para quando um usuário logar ser possível saber as permissões de acesso dele de maneira segura
//para toda ação que o usuário executar depois de logado vai ser necessário "ele mostrar o token pra saber se pode"
...
func extrairToken(r *http.Request) string {
	...
	//token normalmente vem com duas palavras, uma beaver e outra o token em si
