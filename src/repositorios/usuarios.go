...
//pacote responsável por interagir com a tabela usuarios do banco de dados.
//é interessante fazer isso aqui e não nos controllers pois aqui se abstrai o banco de dados utilizado
import (
	"api/src/modelos"
	"database/sql"
	"fmt"
